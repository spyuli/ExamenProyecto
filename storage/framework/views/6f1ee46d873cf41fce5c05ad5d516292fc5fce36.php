...
<form action="/tema/<?php echo e($tema->id); ?>" method="POST">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.plantillabase', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\proyecto_examen\resources\views/examen/edit.blade.php ENDPATH**/ ?>